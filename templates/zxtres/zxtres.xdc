...
set_property PACKAGE_PIN H2 [get_ports UART_TX]
...
#Audio Ear
set_property PACKAGE_PIN B1 [get_ports AUDIO_IN]
set_property IOSTANDARD LVCMOS33 [get_ports AUDIO_IN]
set_property PULLUP true [get_ports AUDIO_IN]

#Audio I2S
set_property PACKAGE_PIN V9 [get_ports I2S_BCK]
set_property IOSTANDARD LVCMOS33 [get_ports I2S_BCK]
set_property PACKAGE_PIN U7 [get_ports I2S_LRCK]
...
set_property PACKAGE_PIN U2 [get_ports JOY_LOAD]
...
set_property PACKAGE_PIN L5 [get_ports SD_CS]
