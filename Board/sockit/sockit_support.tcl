...
set_global_assignment -name VERILOG_FILE ${boardpath}/sockit/audio/audio_top.v
set_global_assignment -name VERILOG_FILE ${boardpath}/sockit/audio/audio_shifter.v
